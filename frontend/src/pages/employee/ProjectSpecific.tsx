    ...
    const handleGenReport = async () => {
        try {
            const response = await axios.post(
                `${import.meta.env.VITE_BACKEND_URL}/api/models/text/notprojectreportgen`,
                {
                    projectData
                }
            );
            ...
            {project.status == "in progress" ? (
                ...
                <div className="w-full h-screen p-10 space-y-3">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <div className="w-full col-span-2 py-6 bg-gray-900 rounded-xl text-center flex flex-col items-center justify-center space-y-4">
                            <h1 className="text-xl font-semibold">{project.name}</h1>
                            <div className="flex justify-center text-sm text-zinc-300 space-x-3">
                                <h2>
                                    {project.status === "in progress"
                    ...
                    <div className="w-full bg-gray-900 rounded-xl p-10">
                        <div className="text-white flex items-center justify-between">
                            <h1 className="text-xl font-bold">Employee Profile</h1>
                            <button
                                className="text-xl font-semibold rounded-full py-2 px-5 bg-slate-500"
