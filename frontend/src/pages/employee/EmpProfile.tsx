...
const EmpProfile: React.FC = () => {
    ...
    useEffect(() => {
        const fetchEmployeeData = async () => {
            try {
                const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/fetch/employee/${id}`);
    ...
    return (
        <div className="w-full h-auto p-10 space-y-6 ">
            <div className="bg-gray-900 p-6 rounded-xl text-white space-y-4 flex items-center justify-between">
                ...
                <button className="text-2xl font-bold bg-green-500" onClick={handleGenReport}>Generate Report</button>
            </div>
